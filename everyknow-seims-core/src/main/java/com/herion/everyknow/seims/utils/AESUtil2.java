...
public class AESUtil2 {
    ...
    // AES_KEY 是经过 Base 64 加密后的. 解密后必须为 16位!!!!!!
    private static String AES_KEY = EknowConfig.getEncryptAESKey();
    ...
    public static String aesDecrypt(String encrypt) {
        try {
            return aesDecrypt(encrypt, Base64ConvertUtil.decode(AES_KEY));
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
    ...
    public static String aesEncrypt(String content) {
        try {
            return aesEncrypt(content, Base64ConvertUtil.decode(AES_KEY));
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
